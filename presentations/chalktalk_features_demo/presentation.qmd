...
::: {.fragment tts="Fragments can enhance various types of content in your slides."}
You can use fragments with:
:::

::: {.fragment tts="Regular text and bullet points to reveal information step by step."}
- Regular text
:::

::: {.fragment tts="Code blocks to walk through code examples incrementally."}
- Code blocks and examples
:::

::: {.fragment tts="Images to introduce visuals at the perfect moment, like this one of three penguin species."}
- Images
...
::: {.fragment tts="You can also add text-to-speech to mathematical equations. For example, here's the quadratic formula."}
...
::: {.fragment tts="Now, let's include a plot using data from the palmerpenguins dataset. Here is the code:"}
...
::: {.fragment tts="Thank you for exploring these advanced features with us. Enjoy creating dynamic and engaging presentations with ChalkTalk."}
