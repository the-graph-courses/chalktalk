...
# ## Example usage
# Example usage modifications throughout the file:
if TEST_FUNCTIONS:
...
def create_presentation_from_prompt(
    prompt: str, title: str = None, name: str = "presentation", num_slides: int = 10
):
    """
...
def server(input, output, session):
    ...
    def _():
        ...
        presentation = pu.generate_slides(
            topic=input.prompt(),
            title=input.prompt(),
            num_slides=input.num_slides(),  # Use the numeric input value
    ...
    def _():
        ...
        # Process HTML with voiceover using the correct functions
